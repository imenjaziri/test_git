...
/* USER CODE BEGIN Header_StartIhmTask */
/**
* @brief Function implementing the IhmTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartIhmTask */
__weak void StartIhmTask(void const * argument)
{
